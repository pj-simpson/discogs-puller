...
def test_artist_releases_request_response(
    test_client, monkeypatch, artist_release_list
):
    with test_client as client:
        monkeypatch.setattr(
            artists, "get_artist_release_list_context_data", artist_release_list
        )
...
def test_release_detail_request_response(
    test_client, monkeypatch, single_release_detail
):
    with test_client as client:
